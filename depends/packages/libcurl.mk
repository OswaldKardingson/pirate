...
$(package)_config_opts_mingw32=--enable-mingw --disable-shared --enable-static --prefix=$(host_prefix) --host=x86_64-w64-mingw32 --with-openssl=$(host_prefix) --without-brotli
$(package)_config_opts_mingw64=--enable-mingw --disable-shared --enable-static --prefix=$(host_prefix) --host=x86_64-w64-mingw64 --with-openssl=$(host_prefix) --without-brotli
...
$(package)_config_env_mingw32=LIBS="-lssl -lcrypto -lz -lws2_32 -lcrypt32"
$(package)_config_env_mingw64=LIBS="-lssl -lcrypto -lz -lws2_32 -lcrypt32"
